...
export function Box({ texture, parameters, scale, position }: BoxProps) {
  ...
  const [scaleX, scaleY, scaleZ] = scale.map(i => i * scaleMultiplier)
  ...
  return (
    <>
      <Plane // Right
        ...
        position={[posX - scaleX / 2, posY, posZ]}
      ...
      <Plane // Front
        ...
        position={[posX, posY, posZ + scaleY / 2]}
        rotation={[0, 0, 0]}
        scale={[scaleX, scaleZ]}
      />
      ...
      <Plane // Top
        ...
        position={[posX, posY + scaleZ / 2, posZ]}
